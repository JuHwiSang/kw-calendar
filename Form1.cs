        ...
        /* private void StyleArrowButton(Button button)
         {
             ...
             button.Font = new Font("Segoe UI", 26F, FontStyle.Regular);
        ...
        */
            ...
            for (int row = 0; row < rowCount; row++)
            {
                for (int col = 0; col < 7; col++)
                {
                    ...
                    else if (day <= daysInMonth)
                    {
                        ...
                        bool isToday = today.Year == FixedYear &&
                                       today.Month == month &&
                                       today.Day == day;
        ...
        private RoundedPanel CreateDayCell(int day, CalendarEventInfo eventInfo, bool isToday)
        {
            ...
            if (eventInfo != null)
            {
                ...
                tag.Click += (s, e) => ShowEventDetail(eventInfo);
                eventLabel.Click += (s, e) => ShowEventDetail(eventInfo);
                //
        ...
        private class CategoryInfo
        {
            ...
            public CategoryInfo(string title, Color dotColor, Color eventBackColor, Color eventForeColor, bool isFavorite)
            {
                Title = title;
                DotColor = dotColor;
